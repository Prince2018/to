...
private WebDriver driver;
 ...
 public void conferenceSection() throws Exception {
   ...
   driver.findElement(By.cssSelector("input.form-control[formcontrolname=email]")).sendKeys("");
  // driver.findElement(By.cssSelector("input.form-control[formcontrolname=email]")).sendKeys("");
   Thread.sleep(1000);
   driver.findElement(By.cssSelector("input.form-control[formcontrolname=password]")).sendKeys("");
   Thread.sleep(2000);
