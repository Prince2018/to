...
public class ReadExcelFile
{
    ...
    {      
        guru99Workbook = new HSSFWorkbook(inputStream);  //If it is xls file then create object of HSSFWorkbook class
    }   
    Sheet guru99Sheet = guru99Workbook.getSheet(sheetName);  //Read sheet inside the workbook by its name    
    ...
    { 
	    ReadExcelFile objExcelFile = new ReadExcelFile();  //Create an object of ReadGuru99ExcelFile class 
	    String filePath = System.getProperty("user.dir")+"\\src\\readandwrite";  //Prepare the path of excel file
	    objExcelFile.readExcel(filePath,"ExportExcel.xlsx","ExcelGuru99Demo");  //Call read file method of the class to read data
    }
